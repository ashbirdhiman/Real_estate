	...
	<div class="container-fluid">
		...
		<div class="head">
		  ...
		  <div class="head">
			...
			<div class="container-fluid">
						<div class="row">
								 <div class="parallax_background parallax-window" data-parallax="scroll"  data-speed="0.8">
									...
									<div class="col-sm-10"style="margin-left:220px;">
			...
			<div class="container-fluid">
                <div class="nav-item">
                    <center>Please give your valuable feedback</center>
                </div>
                <br>
                <br>
        <form  method="post">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO reviews_ratings (user_id, rating, comments, review_date)
            VALUES ('$user_email', , $rating, '$comments', '$date')";
